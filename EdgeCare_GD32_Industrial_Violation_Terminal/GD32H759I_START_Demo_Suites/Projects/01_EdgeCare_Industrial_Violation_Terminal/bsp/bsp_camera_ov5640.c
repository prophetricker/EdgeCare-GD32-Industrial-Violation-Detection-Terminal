...
static uint8_t edgecare_camera_capture_attempt(const char *tag, uint32_t hsync_polarity, uint32_t vsync_polarity)
{
...
uint8_t bsp_camera_ov5640_capture_probe(void)
{
    ...
    return edgecare_camera_capture_attempt("working_hs_blank_low_vs_blank_high",
